...
def parse_args():
    ...
    parser.add_argument("--wandb-project-name", type=str, default="PPO_Lunar_Lander",
    ...
    parser.add_argument("--repo-id", type=str, default="MattStammers/ppo-LunarLander-v2-fullcoded", help="id of the model repository from the Hugging Face Hub {username/repo_name}")
